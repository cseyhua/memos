 ...
 */
export function getDateTimeString(t?: Date | number | string, locale = 'zh'): string {
  const tsFromDate = getTimeStampByDate(t ? t : Date.now());
 ...
 */
export function getDateString(t?: Date | number | string, locale = 'zh'): string {
  const tsFromDate = getTimeStampByDate(t ? t : Date.now());
 ...
 *
 */
export const getRelativeTimeString = (time: number, locale = 'zh', formatStyle: "long" | "short" | "narrow" = "long"): string => {
